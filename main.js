  ...
  async login() {
    ...
    if (this.config.refreshToken) {
      try {
        ...
        this.log.warn('Please obtain a new refresh token using get-refresh-token-simple.js');
        return;
      }
    } else {
      this.log.error('No refresh token configured. Please set a refresh token in the adapter settings.');
      this.log.error('Use get-refresh-token-simple.js to obtain a refresh token.');
      return;
    }
  }
  async getDeviceList() {
